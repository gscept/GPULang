...
#define __FINISH_ENUM(val, key) val = Enumeration(); val.labels = labels; val.values = expressions; val.name = #key; this->staticSymbols.push_back(&val);
...
RenderStateType::RenderStateType()
{
    ...
    __ADD_ENUM(FrontMode);
    __ADD_ENUM(BackMode);
    __ADD_ENUM(FrontAndBackMode);
    ...
    stencilStateMembers.push_back(var);
    var = new Variable(); var->type = Type::FullType{ "uint" }; var->name = "CompareMask";
    stencilStateMembers.push_back(var);
    var = new Variable(); var->type = Type::FullType{ "uint" }; var->name = "WriteMask";
    stencilStateMembers.push_back(var);
    var = new Variable(); var->type = Type::FullType{ "uint" }; var->name = "ReferenceMask";
    stencilStateMembers.push_back(var);
    ...
    __SETUP_MEMBER(this->depthClampEnabled, DepthClampEnabled, bool);
    __SETUP_MEMBER(this->noRasterization, NoRasterization, bool);
    ...
    __SETUP_MEMBER(this->depthBiasEnabled, DepthBiasEnabled, bool);
    __SETUP_MEMBER(this->depthBiasFactor, DepthBiasFactor, float);
    __SETUP_MEMBER(this->depthBiasClamp, DepthBiasClamp, float);
    __SETUP_MEMBER(this->depthBiasSlopeFactor, DepthBiasSlopeFactor, float);
    __SETUP_MEMBER(this->lineWidth, LineWidth, float);
    __SETUP_MEMBER(this->depthTestEnabled, DepthTestEnabled, bool);
    __SETUP_MEMBER(this->depthWriteEnabled, DepthWriteEnabled, bool);
    __SETUP_MEMBER(this->depthTestFunction, DepthTestFunction, CompareMode);
    __SETUP_MEMBER(this->depthBoundsTestEnabled, DepthBoundsTestEnabled, bool);
    __SETUP_MEMBER(this->minDepthBounds, MinDepthBounds, float);
    __SETUP_MEMBER(this->maxDepthBounds, MaxDepthBounds, float);
    __SETUP_MEMBER(this->stencilEnabled, StencilEnabled, bool);
    __SETUP_MEMBER(this->logicOpEnabled, LogicOpEnabled, bool);
    ...
    __SETUP_MEMBER_ARRAY(this->blendEnabled, BlendEnabled, bool, 8);
