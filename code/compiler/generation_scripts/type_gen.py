    ...
    for size in range(1, 5):
        for type, data_type, base_type, bits in zip(types, data_types, base_types, bit_widths):
            ...
            for type2, data_type2, bits2 in zip(types, data_types, bit_widths):
                ...
                spirv_intrinsics.write(spirv_intrinsic(fun_name, '    return GenerateConversionSPIRV(c, g, TypeConversionTable::{}To{}, {}, args[0]);\n'.format(type, type2, size)))
                if size > 1:
                    ...
                    spirv_intrinsics.write(spirv_intrinsic(fun_name, spirv_function))
