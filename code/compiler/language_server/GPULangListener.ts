...
import { TerminateStatementContext } from "./GPULangParser.js";
...
export default class GPULangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by `GPULangParser.terminateStatement`.
	 * @param ctx the parse tree
	 */
	enterTerminateStatement?: (ctx: TerminateStatementContext) => void;
	/**
	 * Exit a parse tree produced by `GPULangParser.terminateStatement`.
	 * @param ctx the parse tree
	 */
