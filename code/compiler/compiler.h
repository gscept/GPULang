...
struct Compiler
{
    ...
    struct Target
    {
        ...
        uint8_t supportsPhysicalBufferAddresses : 1 = 0;
        uint8_t supportsPhysicalAddressing : 1 = 0;
        uint8_t supportsInlineSamplers : 1 = 0;
        uint8_t supportsGlobalDeviceStorage : 1 = 0;
    } target;
    ...
    struct LocalScope
    {
        ...
        LocalScope(LocalScope&& rhs) noexcept
        {
    ...
    struct State
    {
        ...
        ProgramInstance::__Resolved::EntryType shaderType = ProgramInstance::__Resolved::EntryType::InvalidProgramEntryType;
    ...
    Scope *intrinsicScope = nullptr, *mainScope = nullptr;
    ...
    struct Timer
    {
        ...
        {
            this->duration = std::chrono::duration<double, std::milli>::zero();
        }
